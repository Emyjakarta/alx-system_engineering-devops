...
"""Custom methods that defines useful
functions"""
...
def retrieve_todos(user_id=None) -> "list[dict]":
    """
...
def retrieve_completed_tasks(tasks: "list[dict]") -> "list[dict]":
...
def retrieve_name(user_id: int) -> "str | None":
    """
