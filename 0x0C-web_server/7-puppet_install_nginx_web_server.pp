# This manifest configures an Nginx web server with the following:
# - A root page that displays "Hello World!"
# - A redirection page that redirects to
# https://drive.google.com/file/d/130vHZlceKje17SE9uPx8mAZWADVTs3XW/view?usp=sharing/
